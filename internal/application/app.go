...
type App struct {
	...
	custodyChains map[custodyChainCacheKey]domain.CustodyChainResult
}

func New(s *store.Store, a *audit.Audit) *App {
	return &App{Store: s, Audit: a, custodyChains: map[custodyChainCacheKey]domain.CustodyChainResult{}}
}
