...
type Server struct {
	...
	captureLedgerMu    sync.Mutex
	captureLedgerCases map[string]*domain.DigitizationCase
}

func New(a *application.App) *Server {
	return &Server{App: a, captureLedgerCases: map[string]*domain.DigitizationCase{}}
}
