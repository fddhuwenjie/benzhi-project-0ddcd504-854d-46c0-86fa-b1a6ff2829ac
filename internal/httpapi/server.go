...
type Server struct {
	...
	recaptureTimelineMu sync.Mutex
	recaptureTimelines  map[string]recaptureTimelineProjection
}

func New(a *application.App) *Server {
	return &Server{App: a, recaptureTimelines: map[string]recaptureTimelineProjection{}}
}
