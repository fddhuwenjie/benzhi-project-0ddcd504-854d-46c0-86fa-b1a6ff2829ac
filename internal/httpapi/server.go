...
type Server struct {
	...
	assessmentHistoryMu sync.RWMutex
	assessmentHistories map[string][]domain.ConditionAssessment
}

func New(a *application.App) *Server {
	return &Server{App: a, assessmentHistories: map[string][]domain.ConditionAssessment{}}
}
